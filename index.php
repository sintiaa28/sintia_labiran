...
<html lang="en">
  ...
  <body style="background:#85C1E9; font-family:arial">
 
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">TABEL APLIKASI</h5>
  ...
  <?php 
      ...
      <div class="modal-header"><button onclick='change();'  value='show' id='btn1' type="button" class="btn btn-primary">TAMBAH APLIKASI</button></a>
  </div>
<br>
